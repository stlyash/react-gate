        ...
        <div className='row'>
            <div className='col-9 m-0 instruction-body p-0'>
                ...
                style={pageFir===1?{height:"14vh",transform:"translateY(-3.6vh)"}:{height:"31vh",transform:"translateY(-3.6vh)"}}>
                    ...
                    <Link to={checkboxChecked?"/exam":"/instructions"} style={pageFir===1?{display:'none'}:{display:'inline'}}><button onClick={readyclick} style={checkboxChecked?{opacity:1,cursor:'pointer'}:{opacity:'0.6',cursor:'not-allowed'}} className='ready'>I am Ready to Begin</button></Link>
                </div>
            </div>
